...
export class ReactCurrencyFormatter extends Component {
  constructor(props) {
    super(props);
  ...
  getFormatter(p) {
    ...
    const defaultLocales = this.defaultLocales;
  ...
  format(n, p) {
    const formatterFunction = this.getFormatter(p);
  ...
  render() {
    ...
    return (
      <span
        ...
        dangerouslySetInnerHTML={{__html: this.format(quantity, {
          currency,
          symbol,
          locale,
          decimal,
